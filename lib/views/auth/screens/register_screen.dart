...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  Future<void> _register() async {
    ...
    String cleanedName = _nameController.text.trim().replaceAll(RegExp(r'\s+'), ' ');
              ...
              children: [
                ...
                CustomTextField(
                  ...
                  validator: (value) {
                    ...
                    if (trimmed.length > 50) return 'Họ tên không được vượt quá 50 ký tự';
                    return null;
                  },
                ),
                ...
                CustomTextField(
                  ...
                  validator: (value) {
                    ...
                    if (email.contains(' ')) return 'Email không được chứa khoảng trắng';
                ...
                CustomTextField(
                  ...
                  validator: (value) {
                    ...
                    if (!RegExp(r'^(?=.*[A-Z])(?=.*[a-z])(?=.*[0-9])[A-Za-z0-9@]{8,32}$').hasMatch(value)) {
