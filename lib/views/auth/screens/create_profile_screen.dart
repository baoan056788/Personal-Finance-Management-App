...
class _CreateProfileScreenState extends State<CreateProfileScreen> {
  ...
  Future<void> _saveProfile() async {
    ...
    if (_birthday == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Vui lòng chọn ngày sinh'), backgroundColor: Colors.redAccent),
      );
      return;
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color(0xFFFFF8FB), // Very light solid pink-white background
      appBar: AppBar(
        ...
        title: const Text('Tạo hồ sơ', style: TextStyle(color: Colors.black87, fontSize: 18, fontWeight: FontWeight.bold)),
        centerTitle: true,
        actions: [
          IconButton(
              ...
              builder: (ctx) => AlertDialog(
                ...
                actions: [
                  TextButton(
                    ...
                    child: const Text('Đã hiểu', style: TextStyle(color: Color(0xFFB02A76))),
                  ),
                ],
              ),
            ),
                    ...
                    children: [
                        ...
                        child: Column(
                          children: [
                            ...
                            GestureDetector(
                              ...
                              child: const Text(
                                'TẢI ẢNH LÊN',
                                style: TextStyle(color: Color(0xFFB02A76), fontWeight: FontWeight.bold, fontSize: 12),
                              ),
                            ),
                          ],
                        ),
                      ...
                      _buildTextField(
                        ...
                        validator: (value) {
                          ...
                          if (RegExp(r'^[0-9]+$').hasMatch(name)) return 'Họ tên không được chỉ chứa chữ số';
                          if (RegExp(r'[!@#<>?":_`~;[\]\\|=+)(*&^%-]').hasMatch(name)) return 'Họ tên không được chứa ký tự đặc biệt';
                          return null;
                        },
                      ),
                      ...
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          const Text('NGÀY SINH', style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold, color: Colors.black87)),
                          const SizedBox(height: 8),
                          GestureDetector(
                            ...
                            child: Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Text(
                                    _birthday == null ? 'DD / MM / YYYY' : DateFormat('dd / MM / yyyy').format(_birthday!),
                                    style: TextStyle(
                                      fontSize: 14,
                                      color: _birthday == null ? Colors.black26 : Colors.black87,
                                    ),
                                  ),
                        ...
                        child: Row(
                          ...
                          children: [
                            Container(
                              ...
                              child: const Icon(Icons.security, color: Color(0xFFB02A76), size: 18),
                            ),
                            ...
                            const Expanded(
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text('Bảo mật thông tin', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 13, color: Colors.black87)),
                                  SizedBox(height: 4),
                                  Text(
