...
class _GoalListScreenState extends State<GoalListScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Mục tiêu tiết kiệm', style: TextStyle(color: Colors.black87, fontWeight: FontWeight.bold, fontSize: 20)),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      AnimatedSize(
                        ...
                        child: Column(
                          children: displayGoals.map((goal) => _buildGoalCard(goal)).toList(),
                        ),
                      ),
                      if (hasMore)
                        Center(
                          child: TextButton.icon(
                            ...
                            icon: Icon(_isExpanded ? Icons.keyboard_arrow_up : Icons.keyboard_arrow_down, color: const Color(0xFFC2185B)),
                            label: Text(
                            ...
                            style: TextButton.styleFrom(
                              ...
                              backgroundColor: const Color(0xFFC2185B).withAlpha(15),
                            ),
                          ),
                        ),
      ...
      child: Column(
        ...
        children: [
          ...
          ElevatedButton(
            ...
            child: const Text('Tạo Mục Tiêu Ngay', style: TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.bold)),
          )
        ],
      ),
    );
  ...
  Widget _buildHeaderCard(double totalSaved, int totalGoals, double avgProgress) {
    return Container(
            ...
            child: Row(
              ...
              children: [
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    const Text('Số mục tiêu', style: TextStyle(color: Colors.white70, fontSize: 12)),
                    const SizedBox(height: 4),
                    Text('$totalGoals', style: const TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.bold)),
                  ],
                ),
                ...
                Column(
                  ...
                  children: [
                    const Text('Tiến độ trung bình', style: TextStyle(color: Colors.white70, fontSize: 12)),
                    const SizedBox(height: 4),
  ...
  Widget _buildGoalCard(GoalModel goal) {
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(context, MaterialPageRoute(builder: (_) => GoalDetailScreen(goal: goal)));
      },
      child: Container(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Text(
                          ...
                          style: TextStyle(color: _getStatusColor(goal.status), fontSize: 11, fontWeight: FontWeight.bold),
                        ),
                      )
                    ],
                  ),
